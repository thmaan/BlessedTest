...
def post_list(request):
    ...
    return render(request, 'recipe_site/post_list.html', {'posts': posts})
...
def post_detail(request, pk):
    ...
    return render(request, 'recipe_site/post_detail.html', {
        'post': post,
        'liked': liked,
        'reacted': reacted,
...
def post_new(request):
    if request.method == "POST":
        ...
        form = PostForm()
    return render(request, 'recipe_site/post_edit.html', {'form': form})
...
def post_draft_list(request):
    ...
    return render(request, 'recipe_site/post_draft_list.html', {'posts': posts})
...
def add_comment_to_post(request, pk):
    ...
    if request.method == "POST":
        ...
        form = CommentForm()
    return render(request, 'recipe_site/add_comment_to_post.html', {'form': form})
...
def ingredient_new(request):
    if request.method == 'POST':
        ...
        form = IngredientForm()
    return render(request,'recipe_site/ingredient_edit.html',{'form': form})

def ingredients_list(request):
    ingredients = Ingredients.objects.filter().order_by('-quantity')
    return render(request, 'recipe_site/ingredient_list.html', {'ingredients': ingredients})
...
def searchposts(request):
    if request.method == 'GET':
        ...
        if query is not None:
            ...
            return render(request, 'recipe_site/search_post.html', context)
