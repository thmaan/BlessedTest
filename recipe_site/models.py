...
class Post(models.Model):
    ...
    ingredients = models.ManyToManyField('recipe_site.Ingredients')
...
class PostLike(models.Model):
    ...
    post = models.ForeignKey('recipe_site.Post', on_delete=models.CASCADE)
...
class Comment(models.Model):
    post = models.ForeignKey('recipe_site.Post', on_delete=models.CASCADE, related_name='comments')
